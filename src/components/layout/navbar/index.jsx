    ...
    <div className="container">
      <NavbarElement>
          <NavbarLogo>
            <h3>
              <Link to="/">
                <span className="align-middle"> <FeatherLink /> {siteTitle} </span>
              </Link>
            </h3>
          </NavbarLogo> 
          <div className="main-navigation">
            <NavbarList>
              ...
              <li><a href="https://besidereal.com" className="lined-link" activeClassName="active"> <FileText /> <span> Blog </span> </a></li>
            </NavbarList>
          </div>
      </NavbarElement>
    </div>
